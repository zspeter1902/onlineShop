  ...
  data() {
    return {
      ...
      detail: {
        id: 1,
        name: '拼多多公司',
        website: 'http://wwwpinduoduo.com',
        thumb: require('img/logo11.jpg'),
        desc: '拼多多公司成立于2015年9月，作为中国新电商平台的开创者于2018年7月于美国纳斯达克上市。作为国内日活排名第二的B2C电商平台，为中国消费者提供全品类的实惠商品。2019年8月正式上线的多多国际板块，将会为中国消费者引入更多更好更实惠的海外商品。',
        hits: 105145
      },
      total: 23,
      page: {
